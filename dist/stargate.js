...
},{"core-js/fn/regexp/escape":3,"core-js/shim":297,"regenerator-runtime/runtime":299}],2:[function(require,module,exports){
/*
 * Cookies.js - 1.2.2
...
},{"./info.json":301,"./modules/Connection":302,"./modules/Decorators":303,"./modules/Facebook":305,"./modules/File":306,"./modules/Game":307,"./modules/Logger":309,"./modules/Utils":310,"./stargate.conf.js":311,"babel-polyfill":1,"cookies-js":2}],301:[function(require,module,exports){
module.exports={"version":"0.1.2", "build":"v0.1.1-13-gfd18023"}
...
},{"./EventBus":304}],303:[function(require,module,exports){
"use strict";

module.exports.requireCondition = function (param, afterFunction) {
...
},{"./Decorators":303,"./Logger":309}],306:[function(require,module,exports){
'use strict';
...
Object.keys(File).map(function (methodName) {
    File[methodName] = requireCondition(checkPlugins, File[methodName], null, 'Check cordova-plugin-file and zip', 'warn');
});

module.exports = File;

},{"./Decorators":303,"./Logger":309}],307:[function(require,module,exports){
'use strict';
...
function getSDK() {
    ...
    return Promise.all([fileModule.fileExists(constants.SDK_DIR + 'dixie.js'), fileModule.fileExists(constants.SDK_DIR + 'gfsdk.min.js')]).then(function (results) {
        ...
        return Promise.all([fileModule.getMetadata(constants.SDK_DIR + 'dixie.js'), fileModule.getMetadata(constants.SDK_DIR + 'gfsdk.min.js')]);
...
Game.prototype.download = function (gameObject, callbacks) {
    ...
    function start() {
        ...
        return spaceEnough.then(function (result) {
            ...
            return injectScripts(gameObject.id, [constants.SDK_RELATIVE_DIR + 'gamesFixes.js', constants.GAMEOVER_RELATIVE_DIR + 'gameover.css', constants.SDK_RELATIVE_DIR + 'cordova.js', constants.SDK_RELATIVE_DIR + 'cordova_plugins.js', constants.SDK_RELATIVE_DIR + 'dixie.js', constants.SDK_RELATIVE_DIR + 'stargate.js', constants.SDK_RELATIVE_DIR + 'gfsdk.min.js']);
        }).then(function (results) {
...
Game.prototype.buildGameOver = function (datas) {
    ...
    if (!datas.hasOwnProperty('content_id')) {
    ...
    return Promise.all([fileModule.readFileAsJSON(metaJsonPath), fileModule.readFile(constants.GAMEOVER_DIR + 'gameover.html')]).then(function (results) {
        ...
        return htmlString.replace('{{score}}', datas.score).replace('{{game_title}}', metaJson.title).replace('{{game_title}}', metaJson.title).replace('{{url_share}}', metaJson.url_share).replace('{{url_cover}}', metaJson.images.cover.ratio_1);
    });
};
...
function downloadImage(info) {
    ...
    if (info.method === 'xhr') {
        return Promise.all([fileModule.createFile(gameFolder, imageName), Utils.getImageRaw({ url: toDld })]).then(function (results) {
            var entry = results[0];
            var blob = results[1];
...
},{"./File":306,"./Http":308,"./Logger":309,"./Utils":310}],308:[function(require,module,exports){
'use strict';
...
var defaultOptions = {
    ...
    attempt: 1,
    responseType: 'json',
    dataType: 'json', callback: function callback() {},
    ...
    async: true,
    mimeType: '',
    retryAfter: 0, onProgress: function onProgress() {}
};
...
},{"./Logger":309,"./Utils":310}],309:[function(require,module,exports){
"use strict";
...
function Logger(label, tag, styles) {
    ...
    if (!this.isstaging) {
        ...
        consoleInfo = function consoleInfo() {
